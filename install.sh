...
# ============================================================================
# STEP 1：基础工具检查 (curl / git / unzip / openssl)
# ============================================================================
...
ensure_pkg curl; ensure_pkg git; ensure_pkg unzip; ensure_pkg openssl
...
echo -e "    需要重新打开ubuntu穿口加载环境变量"
echo -e "    启动网关命令：openclaw gateway start"
echo ""
